...
The catalog is ~233 tools. Risk varies *within* a family by operation (a `git_status`
...
| Asset bridge | 6 | 1–2 | `asset_receive_*` (base64 chunk relay), `asset_import_url`, `asset_import_latest_download`. Magic-byte + SSRF + SVG-safety checked. See [asset-bridge.md](asset-bridge.md). |
